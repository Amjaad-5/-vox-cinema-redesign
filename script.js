...
arrow.textContent = content.classList.contains("open")? "▲" : "▼";
 ...
 function sendMessage() {
  ...
  chatBox.innerHTML += `<div class="bot">VOX AI: ${response}</div>`;
...
function getBotResponse(msg) {
  if (msg.includes("latest") || msg.includes("movies")) {
    return "🎬 Latest movies: The crush, 7Dogs, Asad";
  }
  ...
  msg.includes("good evening")) {
    return "Hi 👋 Welcome to VOX Cinema!";
  }

  else if (msg.includes("time")) {
    return "🍿 Shows are available all day from 12 PM to 12 AM";
  }

  // booking
  else if (msg.includes("booking"))  {
    return "🎟 To book tickets, go to the booking page, choose your movie, time, and seat. You can also buy snacks to avoid queues, or purchase directly from the ticket counter at the cinema.";
  }
// about price
else if (msg.includes("price") || msg.includes("ticket") || msg.includes("cost")) {
  return "🎟 You can check all ticket prices in the Booking page. Snack and food prices are listed in the Snacks section of the website.";
}
// about the snack
 else if (msg.includes("popcorn") || msg.includes("nachos") || msg.includes("food") || msg.includes("cafeteria")) {
  return "🍿You can order food from the snack page or directly from the snack counter.";
}
...
//about story 
  ...
  return "🎬 The movie story and trailer are available in the Movies page on the website.";
}
  else {
    return "Sorry, I can only help with movie info 🎥";
  }
